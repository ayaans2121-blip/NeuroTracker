        ...
        >
          ...
          >
            ...
            <p className="text-indigo-800/80 mb-8 leading-relaxed">
              Sign up for early access to Parksona. Help us shape the future of Parkinson's tremor measurement.
            </p>
  ...
  return (
    ...
    >
      <div className="flex items-center gap-1.5 md:gap-2 text-lg md:text-xl font-medium tracking-tighter text-indigo-950">
        ...
        <span className="truncate">PARKSONA</span>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          >
            ...
            <h3 className="text-2xl font-medium mb-4 relative z-10 text-indigo-950">Parksona: Objective & Continuous</h3>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
          ...
          >
            ...
            <p className="text-indigo-900/80 mb-8 text-lg leading-relaxed">
              Enhance your clinical assessment with reliable, out-of-clinic data. Parksona provides the longitudinal context missing from brief visits.
            </p>
            <ul className="space-y-6">
              <li className="flex items-start gap-4 text-indigo-900/90">
      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="p-6 glass-panel rounded-2xl mb-16 border-violet-200/50 bg-violet-50/40">
          <div className="flex gap-4">
            ...
            <p className="text-sm text-indigo-900/80 leading-relaxed">
              <strong className="text-indigo-950">Important Clinical Notice:</strong> Parksona is a measurement and monitoring tool designed to assist individuals and healthcare providers in tracking tremor characteristics over time. <strong className="text-indigo-950">It is not a diagnostic product.</strong> The data and summaries generated by Parksona are neutral measurements and do not constitute medical advice, diagnosis, or treatment. Always consult with a qualified healthcare professional regarding any medical condition or treatment decisions.
            </p>
          </div>
        </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-8">
          ...
          <div className="text-sm text-indigo-700/60">
            © {new Date().getFullYear()} Parksona. All rights reserved.
          </div>
        </div>
      </div>
    </footer>
